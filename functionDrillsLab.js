...
/*
  ...
  Create a variable outside the function called 'sum' and set it equal to add invoked (called), passing in 
  2 arguments.
*/
...
let nameGreeting = nameCheck('Wade')
...
function faveColorFinder(color) {
  if (color === 'red') {
    ...
    return 'you need to evalutate your favorite color choice'
  }
}
...
let totalFrogs2 = buyDemFrogsTwo(8)
...
let arrayIsAscending = thisArray(sampleArray2);
